-- Script para aplicar a migration do sistema de mensagens em grupo
...
DROP POLICY IF EXISTS "Group admins can update group details" ON group_chats;
...
DROP POLICY IF EXISTS "Users can manage their own mutes" ON conversation_mutes;
...
DROP TRIGGER IF EXISTS update_group_on_message ON group_messages;
